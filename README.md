...
- 고객이 요구하는 품질의 제품을 최소 비용으로 공급하기 위한
  합리적인 생산계획을 설정하고 생산체제를 효율화함.
- 도넛 생산 공정의 전 과정을 추적하고 제어하는 생산관리시스템(MES) 개발로
  생산성을 높이고 자원을 효율적으로 사용함.

기대효과

- 생산, 품질 등 공정 프로세스 표준화를 통한 실시간 오더 및 프로세스 확인으로
  오작업 조기 예방 및 생산 품질 향상
